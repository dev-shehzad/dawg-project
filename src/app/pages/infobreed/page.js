...
const page = () => {
  return (
    <div className="w-full p-[50px] bg-white max-sm:p-2 max-md:p-2 cursor-pointer ">
      {/* breed info */}
  ...
  <div className="ml-[10px]">
    <div>
      <div className="text-[35px] text-black pt-[50px]"><FaWeight /></div>
      <div className="text-[18px] font-[400px] text-[#4C5559] font-sans pt-1">Weight</div>
      <div className="text-[12px] font-[700px] text-[#363636] font-sans pt-1 ">15 - 20 POUNDS</div>
    </div>
  </div>
  {/* height */}
  ...
  <div className="ml-[10px]">
    <div>
      <div className="text-[35px] text-black pt-[50px]"><CiLineHeight /></div>
      <div className="text-[18px] font-[400px] text-[#4C5559] font-sans pt-1">Height</div>
      <div className="text-[12px] font-[700px] text-[#363636] font-sans pt-1 ">20 - 24 INCHES</div>
    </div>
  </div>
  {/* heart */}
  <div className="border-b border-black border-solid w-[250px]  "></div>
...
<LuHeartPulse /></div>
      <div className="text-[18px] font-[400px] text-[#4C5559] font-sans pt-1">Longevity</div>
      <div className="text-[12px] font-[700px] text-[#363636] font-sans pt-1 ">11 - 14 YEARS</div>
    </div>
  </div>
  <div className="border-b border-black border-solid w-[120px]  "></div>
      ...
      {/* last part */}
      <div className=" h-[800px] w-full bg-[rgba(240,231,231,0.49)] mt-[70px] p-[30px] max-sm:w-full max-sm:h-auto md:h-auto">
        {/* good to know */}
        ...
        {/*flex4 last part  */}
        <div className=" flex flex-wrap m-[50px] max-sm:flex-col max-sm:m-auto max-sm:mt-[20px]">
          {/* part1 */}
          ...
          <div className=" w-[400px] flex ml-[100px] max-sm:ml-0 max-sm:w-full max-sm:mt-3 max-md:ml-0 max-md:mt-[20px] ">
           ...
           <div className=" w-[430px] flex mt-[40px] max-sm:w-full">
            ...
            <div>
              ...
              <div className=" text-[18px] font-[400px] text-[#4C5559]  font-sans  pl-[15px]   pt-[10px]  ">
              Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo nullam est dolorem. Ut elit tellus, luctus nec ullamcorper mattis. Donec a nisl a eros volutpat imperdiet 
              </div>
            </div>
          </div>
          {/* part4 */}
          <div className=" w-[400px] flex ml-[100px] mt-[40px] max-sm:ml-0 max-sm:w-full max-md:ml-0 max-md:mt-[20px]  ">
            ...
            <div>
              ...
              <div className=" text-[18px] font-[400px] text-[#4C5559]  font-sans  pl-[15px]   pt-[10px]  ">
              Cras dictum, augue eget vestibulum suscipit, urna lectus iaculis lorem, et eleifend velit dui auctor nunc.
              </div>
            </div>
          </div>
           {/* part5 */}
           <div className=" w-[430px] flex mt-[40px] max-sm:w-full">
            ...
            <div>
              ...
              <div className=" text-[18px] font-[400px] text-[#4C5559]  font-sans  pl-[15px]   pt-[10px]  ">
              Cras porttitor odio sed tellus eleifend posuere. Phasellus viverra, ante sit amet euismod bibendum, dui justo interdum ligula, non sodales magna turpis nec ligula.
              </div>
            </div>
          </div>
        </div>
