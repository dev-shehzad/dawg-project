...
const page = () => {
 ...
 Sire
      ...
      This is the category where all of our Bois find their place. Dawgs and Dawg Categories work identically to WordPress Posts and Post Categories.
        ...
        <div className=" w-[470px] h-[600px] max-sm:mt-[60px] max-sm:w-full ">
         ...
         <div className=" w-[470px] h-[600px] max-sm:mt-[60px] max-sm:w-full">
          <img
            ...
            className=" w-[100%] h-[100%]  transform transition duration-300 ease-in-out hover:scale-110 hover:opacity-80"
          ></img>
